...
00:37:16 - 01.05 - The major steps in modelling with TensorFlow (40:30))
...
01:13:02 - 01.09 - Evaluating a TensorFlow model - Part 1 ("visualise, visualise, visualise") (7:24)
...
01:44:03 - 01.12 - Evaluating a TensorFlow model - Part 4 (visualising a model's layers) (7:14)
02:01:23 - 01.13 - Evaluating a TensorFlow model - Part 5 (visualising a model's predictions) (9:16)
...
04:28:08 - 01.27 - Preprocessing data with feature scaling - Part 2 (normalising our data) (10:57)
...
04:19:17 - 02.27 - Multi-class classification - Part 4 (Improving performance with normalisation) (12:43)
04:32:01 - 02.28 - Multi-class classification - Part 5 (Comparing normalised and non-normalised data) (4:13)
...
05:04:38 - 02.32 - Multi-class classification - Part 9 (Visualising random model predictions) (10:42)
...
## 05 - Transfer Learning in TensorFlow - Part 2 :: Fine Tuning
 ...
 - 05.13 - Visualizing what happens when images pass through our data augmentation layer (10:56)
 - 05.14 - Building Model 1 (with a data augmentation layer and 1% of training data) (15:55)
 - 05.15 - Building Model 2 (with a data augmentation layer and 10% of training data) (16:37)
 - 05.16 - Creating a ModelCheckpoint to save our model's weights during training (7:25)
 - 05.17 - Fitting and evaluating Model 2 (and saving its weights using ModelCheckpoint) (7:14)
 - 05.18 - Loading and comparing saved weights to our existing trained Model 2 (7:17)
 - 05.19 - Preparing Model 3 (our first fine-tuned model) (20:26)
 - 05.20 - Fitting and evaluating Model 3 (our first fine-tuned model) (7:45)
 - 05.21 - Comparing our model's results before and after fine-tuning (10:26)
 - 05.22 - Downloading and preparing data for our biggest experiment yet (Model 4) (6:24)
 - 05.23 - Preparing our final modelling experiment (Model 4) (12:00)
 - 05.24 - Fine-tuning Model 4 on 100% of the training data and evaluating its results (10:19)
 - 05.25 - Comparing our modelling experiment results in TensorBoard (10:46)
 - 05.26 - How to view and delete previous TensorBoard experiments (2:04)
