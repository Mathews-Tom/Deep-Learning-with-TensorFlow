...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ Chapters ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬    
09.01 - Introduction to Milestone Project 2. SkimLit (14.20)    
09.02 - What we're going to cover in Milestone Project 2 (NLP for medical abstracts) (7.22)    
09.03 - SkimLit inputs and outputs (11.02)    
09.04 - Setting up our notebook for Milestone Project 2 (getting the data) (14.58)    
09.05 - Setting up our notebook for Milestone Project 2 (getting the data) (14.58)    
09.06 - Writing a preprocessing function to structure our data for modelling (19.50)    
09.07 - Performing visual data analysis on our preprocessed text (7.55)    
09.08 - Turning our target labels into numbers (ML models require numbers) (13.15)    
09.09 - Model 0. Creating, fitting and evaluating a baseline model for SkimLit (9.25)    
09.10 - Preparing our data for deep sequence models (9.55)    
09.11 - Creating a text vectoriser to map our tokens (text) to numbers (14.07)    
09.12 - Creating a custom token embedding layer with TensorFlow (9.14)    
09.13 - Creating fast loading dataset with the TensorFlow tf.data API (9.49)    
09.14 - Model 1. Building, fitting and evaluating a Conv1D with token embeddings (17.21)    
09.15 - Preparing a pretrained embedding layer from TensorFlow Hub for Model 2 (10.53)    
09.16 - Model 2. Building, fitting and evaluating a Conv1D model with token embeddings (11.30)    
09.17 - Creating a character-level tokeniser with TensorFlow's TextVectorization layer (23.24)    
09.18 - Creating a character-level embedding layer with tf.keras.layers.Embedding (7.44)    
09.19 - Model 3. Building, fitting and evaluating a Conv1D model on character embeddings (13.45)    
09.20 - Discussing how we're going to build Model 4 (character + token embeddings) (6.04)    
09.21 - Model 4. Building a multi-input model (hybrid token + character embeddings) (15.36)    
09.22 - Model 4. Plotting and visually exploring different data inputs (7.32)    
09.23 - Crafting multi-input fast loading tf.data datasets for Model 4 (8.41)    
09.24 - Model 4. Building, fitting and evaluating a hybrid embedding model (13.18)    
09.25 - Model 5. Adding positional embeddings via feature engineering (overview) (7.18)    
09.26 - Encoding the line number feature to used with Model 5 (12.25)    
09.27 - Encoding the total lines feature to be used with Model 5 (7.56)    
09.28 - Model 5. Building the foundations of a tribrid embedding model (9.19)    
09.29 - Model 5. Completing the build of a tribrid embedding model for sequences (14.08)    
09.30 - Visually inspecting the architecture of our tribrid embedding model (10.25)    
09.31 - Creating multi-level data input pipelines for Model 5 with the tf.data API (9.00)    
09.32 - Bringing SkimLit to life!!! (fitting and evaluating Model 5) (10.35)    
09.33 - Comparing the performance of all of our modelling experiments (9.36)    
09.34 - Comparing the performance of all of our modelling experiments (9.36)    
09.35 - Congratulations and your challenge before heading to the next module (12.33)    
